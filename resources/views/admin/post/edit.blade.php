            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group @if($errors->has('category_id')) has-error @endif">
                        {!! Form::label('Category') !!}
                        {!! Form::select('category_id[]', $categories, null, ['class' => 'form-control', 'id' =>
                        'category_id', 'multiple' => 'multiple']) !!}
                    ...
                    <div class="form-group @if($errors->has('is_published')) has-error @endif">
                        {!! Form::label('Publish') !!}
                        {!! Form::select('is_published', [1 => 'publish', 0 => 'draft'], $post->is_published, ['class' =>
                        'form-control']) !!}
